        ...
        {gameSetup.step === 'formation' && (
          <div className="space-y-4 sm:space-y-6">
            <div className="bg-white rounded-lg shadow-lg p-3 sm:p-6">
              ...
              <div className="bg-green-100 border-2 border-green-300 rounded-lg p-4 sm:p-8 mb-4 sm:mb-6 overflow-x-auto">
                <div className="relative w-full max-w-xs sm:max-w-md mx-auto" style={{ aspectRatio: '2/3', minWidth: '280px' }}>
                  {/* Veld */}
                  <div className="w-full h-full bg-green-200 border-2 border-white rounded relative">
                    ...
                    <div className="absolute top-3 sm:top-4 left-1/2 transform -translate-x-1/2">
                      ...
                      <div className="text-xs text-center mt-1 font-bold text-gray-900 bg-white px-1 sm:px-2 py-0.5 sm:py-1 rounded shadow max-w-[60px] sm:max-w-none truncate">
                    ...
                    <div className="absolute top-12 sm:top-20 left-4 sm:left-8">
                      ...
                      <div className="text-xs text-center mt-1 font-bold text-gray-900 bg-white px-1 py-0.5 rounded shadow w-10 sm:w-16 truncate">
                        {gameSetup.group1.filter(p => p.id !== gameSetup.keeper1?.id)[0]?.name || 'Speler'}
                      </div>
                    </div>

                    <div className="absolute top-12 sm:top-20 right-4 sm:right-8">
                      <div className="bg-green-500 border-2 border-green-700 rounded-full w-6 h-6 sm:w-10 sm:h-10 flex items-center justify-center text-xs font-bold text-white shadow-lg">
                        RA
                      </div>
                      <div className="text-xs text-center mt-1 font-bold text-gray-900 bg-white px-1 py-0.5 rounded shadow w-10 sm:w-16 truncate">
                    ...
                    {/* Aanvallers */}
                    <div className="absolute bottom-12 sm:bottom-20 left-4 sm:left-8">
                      <div className="bg-blue-500 border-2 border-blue-700 rounded-full w-6 h-6 sm:w-10 sm:h-10 flex items-center justify-center text-xs font-bold text-white shadow-lg">
                        LV
                      </div>
                      <div className="text-xs text-center mt-1 font-bold text-gray-900 bg-white px-1 py-0.5 rounded shadow w-10 sm:w-16 truncate">
                    ...
                    <div className="absolute bottom-12 sm:bottom-20 right-4 sm:right-8">
                      <div className="bg-green-500 border-2 border-green-700 rounded-full w-6 h-6 sm:w-10 sm:h-10 flex items-center justify-center text-xs font-bold text-white shadow-lg">
                        RV
                      </div>
                      <div className="text-xs text-center mt-1 font-bold text-gray-900 bg-white px-1 py-0.5 rounded shadow w-10 sm:w-16 truncate">
                    ...
                    {/* Wisselspelers - Positioneer anders voor mobile */}
                    <div className="absolute top-8 sm:top-16 -right-16 sm:-right-24">
                      <div className="text-xs sm:text-sm font-bold mb-1 sm:mb-2 text-gray-900">Wisselbank</div>
                      <div className="space-y-2 sm:space-y-3">
                        {/* Keeper2 als wissel */}
                        <div className="text-center">
                          <div className="bg-blue-400 border-2 border-blue-600 rounded-full w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center text-xs font-bold text-white shadow">
                            K2
                          </div>
                          <div className="text-xs font-bold w-12 sm:w-16 mt-1 text-gray-900 bg-white px-1 py-0.5 rounded shadow truncate">
                        ...
                        <div className="text-center">
                          <div className="bg-green-400 border-2 border-green-600 rounded-full w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center text-xs font-bold text-white shadow">
                            W
                          </div>
                          <div className="text-xs font-bold w-12 sm:w-16 mt-1 text-gray-900 bg-white px-1 py-0.5 rounded shadow truncate">
